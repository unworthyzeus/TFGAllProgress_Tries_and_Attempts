#!/usr/bin/env python3
"""Submit Try74 experts as parallel 2-GPU Slurm jobs (no sequential dependency chain).

Each train job uses cluster/run_seventyfourth_try74_2gpu.slurm.
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Submit parallel Try74 2-GPU jobs (one Slurm job per expert, same time)."
    )
    parser.add_argument(
        "expert_ids",
        nargs="*",
