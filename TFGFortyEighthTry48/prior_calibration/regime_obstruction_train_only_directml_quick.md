...
- Base formula: `hybrid_damped_coherent_two_ray_obstruction_vinogradov_nlos`.
...
- `overall`: RMSE `23.7854 dB`, MAE `12.2699 dB`, count `48861408`
- `LoS`: RMSE `3.6156 dB`, MAE `2.8192 dB`, count `33048375`
- `NLoS`: RMSE `41.4825 dB`, MAE `32.0215 dB`, count `15813033`
