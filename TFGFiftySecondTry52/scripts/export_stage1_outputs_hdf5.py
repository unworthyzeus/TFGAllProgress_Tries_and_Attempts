...
def flush_batch(
    *,
    ...
    with torch.no_grad():
        residual = forward_cgan_generator(model, x_batch, scalar_batch)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Export Try 52 stage1 predictions to HDF5 for the tail refiner")
