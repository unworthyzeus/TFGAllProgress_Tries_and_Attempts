...
def apply_runtime_overrides(
    ...
    try70_init_checkpoint: Optional[str] = None,
) -> Dict[str, Any]:
    if seed_offset:
    ...
    if try70_init_checkpoint:
        try70_cfg = dict(cfg.get('try70', {}))
        try70_cfg['init_checkpoint'] = try70_init_checkpoint
        cfg['try70'] = try70_cfg
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default='',
        help='Override try70.init_checkpoint (Try 68 best_model warm-start, strict=False).',
    )
    ...
    cfg = apply_runtime_overrides(
        ...
        args.try70_init_checkpoint or None,
    )
