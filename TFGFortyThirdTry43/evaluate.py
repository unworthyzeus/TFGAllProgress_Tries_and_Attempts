...
from train_pmnet_direct import evaluate_validation


def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate Try 43 PMNet direct path-loss model")
    parser.add_argument("--config", type=str, default="experiments/fortythirdtry43_pmnet_no_prior/fortythirdtry43_pmnet_no_prior.yaml")
