# Try 55/56 Overfitting Mitigation Options
...
We already improved this in `Try 55`, but the general principle still matters.
...
This matters more for `Try 55` than for `Try 56`, but the idea is useful:
...
- in `Try 55`, we often see training keep improving while validation becomes
