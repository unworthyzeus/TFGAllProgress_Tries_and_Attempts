...
def main() -> None:
    parser = argparse.ArgumentParser(description="Upload Try55 and submit the 6 partitioned experts as 2-GPU jobs with cleanup between jobs.")
    ...
    parser.add_argument("--wipe-try55-outputs", action="store_true", default=False)
    ...
    try:
        ...
        initial_cleanup = remote_sbatch(
            client,
            f"{sbatch_prefix} cluster/run_fiftyfifthtry55_cleanup_sert2001_1gpu.slurm",
        )
        ...
        for idx, expert in enumerate(experts):
            ...
            cmd = (
                ...
                "cluster/run_fiftyfifthtry55_partitioned_expert_2gpu.slurm"
            )
