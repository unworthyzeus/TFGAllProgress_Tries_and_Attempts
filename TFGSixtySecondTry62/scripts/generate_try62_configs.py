...
def main() -> None:
    ...
    stage1_dir = root / "experiments" / "sixtysecondtry62_partitioned_stage1"
    stage2_dir = root / "experiments" / "sixtysecondtry62_tail_refiner_stage2"
    classifier_dir = root / "experiments" / "sixtysecondtry62_topology_classifier"
    stage1_dir.mkdir(parents=True, exist_ok=True)
    stage2_dir.mkdir(parents=True, exist_ok=True)
    classifier_dir.mkdir(parents=True, exist_ok=True)

    _cleanup_existing(stage1_dir, "sixtysecondtry62_expert_*.yaml")
    _cleanup_existing(stage2_dir, "sixtysecondtry62_tail_refiner_*.yaml")

    stage1_registry = {"experts": []}
    stage2_registry = {"experts": []}

    for spec in TRY62_EXPERT_SPECS:
        ...
        stage1_cfg["data"]["image_size"] = 513
        stage1_cfg["data"]["num_workers"] = 6
        stage1_cfg["data"]["val_num_workers"] = 2
        stage1_cfg["data"]["val_batch_size"] = 2
        ...
        formula_cfg["cache_dir"] = "prior_cache/try62_prior_auto_city_v1"
        formula_cfg["cache_version"] = "try62_prior_auto_city_v1"
        ...
        stage1_cfg["training"]["batch_size"] = 2
        ...
        stage1_cfg["training"]["selection_metrics"] = {"path_loss.rmse_physical": 1.0}
        ...
        stage1_name = f"sixtysecondtry62_expert_{spec['expert_id']}"
        ...
        stage2_cfg["data"]["path_loss_formula_input"]["cache_dir"] = "prior_cache/try62_prior_auto_city_v1"
        stage2_cfg["data"]["path_loss_formula_input"]["cache_version"] = "try62_prior_auto_city_v1"
        ...
        stage2_name = f"sixtysecondtry62_tail_refiner_{spec['expert_id']}"
    ...
    classifier_cfg = {
        ...
        "runtime": {
            "device": "cuda",
            "output_dir": "outputs/sixtysecondtry62_topology_classifier",
            "resume_checkpoint": "",
        },
    }
    classifier_path = classifier_dir / "sixtysecondtry62_topology_classifier.yaml"
    with classifier_path.open("w", encoding="utf-8") as handle:
        yaml.safe_dump(classifier_cfg, handle, sort_keys=False)

    with (stage1_dir / "sixtysecondtry62_expert_registry.yaml").open("w", encoding="utf-8") as handle:
        yaml.safe_dump(stage1_registry, handle, sort_keys=False)
    with (stage2_dir / "sixtysecondtry62_tail_refiner_registry.yaml").open("w", encoding="utf-8") as handle:
