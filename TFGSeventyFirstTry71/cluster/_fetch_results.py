...
USER = "gmoreno"
BASE = "/scratch/nas/3/gmoreno/TFGpractice/TFGSeventyFirstTry71"
...
def main():
    ...
    print("=== OUT LOG ===")
    out = r(c, f"cat {BASE}/logs_train_try71_t68-open-sparse-lowrise_10027953.out 2>/dev/null")
    print(out[:4000])
    print()

    expert_dir = f"{BASE}/outputs/try71_expert_open_sparse_lowrise"
