...
out_dir = "/scratch/nas/3/gmoreno/TFGpractice/TFGSeventyFirstTry71/outputs/try71_expert_open_sparse_lowrise"
...
cmd2 = f"grep '\"epoch\"' $(ls -t /scratch/nas/3/gmoreno/TFGpractice/TFGSeventyFirstTry71/logs_train_try71_*.out 2>/dev/null | head -1) | tail -20"
