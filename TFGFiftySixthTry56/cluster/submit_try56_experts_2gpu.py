...
def main() -> None:
    parser = argparse.ArgumentParser(description="Upload Try56 and submit the 6 topology experts as 2-GPU jobs with cleanup between jobs.")
    ...
    try:
        ...
        for expert in experts:
            ...
            job_id = remote_sbatch(
                ...
                "cluster/run_try56_topology_expert_2gpu.slurm",
            )
