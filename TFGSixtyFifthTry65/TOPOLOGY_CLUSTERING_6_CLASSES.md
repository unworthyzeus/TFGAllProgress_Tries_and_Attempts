...
This note documents how the dataset is partitioned into the 6 topology classes used by the expert models in Try 55, 56, 57, 58, and 59.
...
- Try 57 config generator: `C:\TFG\TFGpractice\TFGFiftySeventhTry57\scripts\generate_try57_configs.py`
- Expert registry: `C:\TFG\TFGpractice\TFGFiftySeventhTry57\experiments\fiftyseventhtry57_partitioned_stage1\fiftyseventhtry57_expert_registry.yaml`
...
For Try 57, the YAML explicitly sets:
...
These are the thresholds currently used by the expert configs generated in Try 57.
...
## Try 57 Expert Mapping

The Try 57 expert registry maps one model per class:
