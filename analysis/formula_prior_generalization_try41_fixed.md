...
- `raw_prior`: RMSE `67.2263 dB`, MAE `37.4754 dB`, count `485380287`
- `global_affine`: RMSE `26.9666 dB`, MAE `18.1611 dB`, count `485380287`
- `city_type_affine`: RMSE `26.9552 dB`, MAE `18.1212 dB`, count `485380287`
- `city_type_los_affine`: RMSE `24.2927 dB`, MAE `12.7874 dB`, count `485380287`
- `city_type_los_ant_affine`: RMSE `24.1744 dB`, MAE `12.6863 dB`, count `485380287`
- `city_type_los_ant_quadratic`: RMSE `24.1602 dB`, MAE `12.6748 dB`, count `485380287`
- `global_affine_support_scaled`: RMSE `34.0997 dB`, MAE `28.6163 dB`, count `485380287`
- `city_type_los_affine_support_scaled`: RMSE `26.1677 dB`, MAE `9.5857 dB`, count `485380287`
- `city_type_los_ant_affine_support_scaled`: RMSE `26.1013 dB`, MAE `9.5738 dB`, count `485380287`
- `city_type_los_ant_quadratic_support_scaled`: RMSE `26.0969 dB`, MAE `9.5715 dB`, count `485380287`

## Recommended Prior-Only System

- Best validation system: `city_type_los_ant_quadratic`
- Validation RMSE: `24.1602 dB`
