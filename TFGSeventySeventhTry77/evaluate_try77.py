...
Usage:
    python evaluate_try77.py --config .../config.yaml --checkpoint .../best_model.pt
"""
...
from src.data_utils import HeightEmbedding, Try77Config, build_expert_datasets
from src.metrics_try77 import (
    kl_from_counts,
    masked_mae,
    masked_rmse,
    per_image_histogram,
...
def main() -> None:
    ...
    for batch in loader:
        ...
        hist_rows.append([batch["city"][0], batch["sample"][0], float(h.item()),
                          "TFGSeventySeventhTry77", expert_id, cfg.data.metric,
