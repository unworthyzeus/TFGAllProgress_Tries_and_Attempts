#!/usr/bin/env python3
"""Submit chained 1-GPU Slurm jobs for Try 77 experts (train -> cleanup -> ...)."""
...
TRAIN_SLURM = "cluster/run_seventyseventh_try77_1gpu.slurm"
CLEANUP_SLURM = "cluster/run_seventyseventh_try77_cleanup_sert2001_1gpu.slurm"
DEFAULT_BASE_MASTER_PORT = 31788
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Submit chained Try 77 1-GPU jobs (one per expert, with cleanup between)."
    )
