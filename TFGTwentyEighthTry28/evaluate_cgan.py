...
def main() -> None:
    ...
    bottleneck_attention = bool(cfg['model'].get('bottleneck_attention', False))
    bottleneck_attention_dim = int(cfg['model'].get('bottleneck_attention_dim', 256))
    bottleneck_attention_heads = int(cfg['model'].get('bottleneck_attention_heads', 4))
    generator = UNetGenerator(
        ...
        bottleneck_attention_dim=bottleneck_attention_dim,
