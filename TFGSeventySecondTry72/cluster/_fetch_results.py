...
USER = "gmoreno"
BASE = "/scratch/nas/3/gmoreno/TFGpractice/TFGSeventySecondTry72"
...
def main():
    ...
    print("=== OUT LOG ===")
    out = r(c, f"cat {BASE}/logs_train_try72_t72-open-sparse-lowrise_10027953.out 2>/dev/null")
    print(out[:4000])
    print()

    expert_dir = f"{BASE}/outputs/try72_expert_open_sparse_lowrise"
