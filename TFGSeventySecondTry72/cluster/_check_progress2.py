...
out_dir = "/scratch/nas/3/gmoreno/TFGpractice/TFGSeventySecondTry72/outputs/try72_expert_open_sparse_lowrise"
...
cmd2 = f"grep '\"epoch\"' $(ls -t /scratch/nas/3/gmoreno/TFGpractice/TFGSeventySecondTry72/logs_train_try72_*.out 2>/dev/null | head -1) | tail -20"
