"""Plot Try 76 training curves from outputs or cluster_outputs history files.

Usage:
    python scripts/plot_history.py outputs/try76_expert_open_sparse_lowrise_los
    python scripts/plot_history.py cluster_outputs/TFGSeventySixthTry76/try76_expert_open_sparse_lowrise_los
    python scripts/plot_history.py outputs/try76_expert_*
    python scripts/plot_history.py --all outputs/ cluster_outputs/TFGSeventySixthTry76
...
METRIC_PANELS = [
    ("RMSE (dB)", [("train.rmse_db", "train"), ("val.rmse_db", "val")]),
    (
        "Distribution losses",
        [
...
def main() -> None:
    ...
    default_paths = [
        try_root / "outputs",
        project_root / "cluster_outputs" / "TFGSeventySixthTry76",
    ]
