#!/usr/bin/env python3
"""Submit chained 4-GPU Slurm jobs for Try 76 experts (train -> cleanup -> ...)."""
...
TRAIN_SLURM = "cluster/run_seventysixth_try76_4gpu.slurm"
CLEANUP_SLURM = "cluster/run_seventysixth_try76_cleanup_sert2001_1gpu.slurm"
DEFAULT_BASE_MASTER_PORT = 30988
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Submit chained Try 76 4-GPU jobs (one per expert, with cleanup between)."
    )
