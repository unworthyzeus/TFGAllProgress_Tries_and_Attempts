...
def main() -> None:
    parser = argparse.ArgumentParser(description="Try52 local smoke test for prior and confidence channel")
    parser.add_argument("--config", required=True, help="Path to Try52 YAML config")
    ...
    print("[PASS] Try52 prior smoke test completed successfully.")
