...
def main() -> None:
    parser = argparse.ArgumentParser(description="Upload Try59 and submit the 6 topology experts as 4-GPU jobs with cleanup between jobs.")
    ...
    try:
        ...
        for expert in experts:
            ...
            job_id = remote_sbatch(
                ...
                "cluster/run_try59_topology_expert_4gpu.slurm",
            )
