...
def main() -> None:
    parser = argparse.ArgumentParser(description="Submit Try59 experts as two 3-job waves of 1-GPU jobs.")
    ...
    parser.add_argument("--wipe-try59-outputs", action="store_true")
    ...
    try:
        ...
        initial_cleanup = remote_sbatch(
            client,
            f"{sbatch_prefix} {cleanup_dependency}cluster/run_fiftyninthtry59_cleanup_sert2001_1gpu.slurm",
        )
        ...
        for idx, expert in enumerate(wave1):
            ...
            job_id = remote_sbatch(
                ...
                "cluster/run_try59_topology_expert_1gpu.slurm",
            )
        ...
        final_cleanup = remote_sbatch(
            ...
            "cluster/run_fiftyninthtry59_cleanup_sert2001_1gpu.slurm",
        )
