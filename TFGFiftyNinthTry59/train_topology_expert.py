...
def main() -> None:
    parser = argparse.ArgumentParser(description='Train a Try 59 topology expert')
    parser.add_argument('--config', type=str, default='experiments/fiftyninthtry59_topology_experts/fiftyninthtry59_expert_open_sparse_lowrise.yaml')
