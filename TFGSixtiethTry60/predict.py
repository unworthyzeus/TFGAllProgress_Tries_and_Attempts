...
def main() -> None:
    parser = argparse.ArgumentParser(description="Predict with Try 60 direct path-loss expert")
    parser.add_argument("--config", type=str, default="experiments/sixtiethtry60_partitioned_stage1/sixtiethtry60_expert_open_sparse_lowrise.yaml")
