...
"""
Evaluate trained CKM model on the TEST partition (unseen data).
"""
...
MANIFEST_FILE = r"c:/TFG/TFGPractice/CKMImagenet/Datasets/test_manifest.csv"
...
def main():
    ...
    if len(dataset) == 0:
        print(f"No valid test samples found.")
        return
    ...
    # Print results
    print("\n" + "=" * 60)
    print(f"TEST RESULTS (UNSEEN DATA)")
    print("=" * 60)
