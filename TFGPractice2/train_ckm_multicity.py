...
DATA_ROOT = r"c:/TFG/TFGPractice/CKMImagenet" # Point to the original data

BATCH_SIZE = 8          # Reduced to 8 as per user request to improve responsiveness
LEARNING_RATE = 1e-4
NUM_EPOCHS = 50
