...
USER = "gmoreno"
BASE = "/scratch/nas/3/gmoreno/TFGpractice/TFGSeventyThirdTry73"
...
def main():
    ...
    print("=== OUT LOG ===")
    out = r(c, f"cat {BASE}/logs_train_try73_t73-open-sparse-lowrise_10027953.out 2>/dev/null")
    print(out[:4000])
    print()

    expert_dir = f"{BASE}/outputs/try73_expert_open_sparse_lowrise"
