...
out_dir = "/scratch/nas/3/gmoreno/TFGpractice/TFGSeventyThirdTry73/outputs/try73_expert_open_sparse_lowrise"
...
cmd2 = f"grep '\"epoch\"' $(ls -t /scratch/nas/3/gmoreno/TFGpractice/TFGSeventyThirdTry73/logs_train_try73_*.out 2>/dev/null | head -1) | tail -20"
