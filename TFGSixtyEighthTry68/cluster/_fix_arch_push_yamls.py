...
Run from repo root or TFGSixtyEighthTry68/.
"""
import paramiko
import pathlib
...
CLUSTER_EXPERIMENTS = (
    "/scratch/nas/3/gmoreno/TFGpractice/TFGSixtyEighthTry68/experiments/sixtyeighth_try68_experts"
)

HERE = pathlib.Path(__file__).parent.parent  # TFGSixtyEighthTry68/
LOCAL_YAMLS_DIR = HERE / "experiments" / "sixtyeighth_try68_experts"

EXPERTS_TO_FIX = [
    "try68_expert_mixed_compact_midrise.yaml",
    "try68_expert_dense_block_midrise.yaml",
    "try68_expert_dense_block_highrise.yaml",
]
