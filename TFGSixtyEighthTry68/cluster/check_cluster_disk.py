#!/usr/bin/env python3
"""SSH to the cluster and print disk usage for scratch / home / Try 68 tree.
...
USER = "gmoreno"
# Paths used by Try 68 jobs (see submit_try68_stage1_stage2_4gpu.py)
REMOTE_SCRATCH_USER = "/scratch/nas/3/gmoreno"
REMOTE_TFG_ROOT = f"{REMOTE_SCRATCH_USER}/TFGpractice"
REMOTE_TRY66 = f"{REMOTE_TFG_ROOT}/TFGSixtyEighthTry68"
...
echo ""
echo "========== Largest items under Try 68 outputs (top 12) =========="
