# DataLoader, batch y gradient accumulation (Try 68)

Los expertos están en `experiments/sixtyeighth_try68_experts/try68_expert_*.yaml`.
...
|------|--------|------|---------|
| 1 | `cluster/run_sixtyeighth_try68_1gpu.slurm` | 6 | 38G |
| 2 | `cluster/run_sixtyeighth_try68_2gpu.slurm` | 24 | 78G |
| 3 | `cluster/run_sixtyeighth_try68_3gpu_medium_gpu.slurm` (`qos=medium_gpu`) | 24 | 120G |
| 4 | `cluster/run_sixtyeighth_try68_4gpu.slurm` | 32 | 120G |
...
## Baseline actual en repo (expertos Try 68)
