...
class PMHHNetResidualRegressor(PMHNetResidualRegressor):
    ...
    PMHHNet:
    - PMHNet backbone
    - plus continuous antenna-height conditioning through FiLM-style modulation
    - designed to generalize across heights instead of routing to separate
      height-specific experts
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.film_context = FiLMAffine(hidden_dim, int(base_channels * 8), hidden_dim=hidden_dim)
    ...
    def _resolve_scalar_cond(self, x: torch.Tensor, scalar_cond: torch.Tensor | None) -> torch.Tensor:
        ...
        return self.scalar_embed(scalar_cond)
