...
def main() -> None:
    parser = argparse.ArgumentParser(description="Try49 local smoke test for prior and confidence channel")
    parser.add_argument("--config", required=True, help="Path to Try49 YAML config")
    ...
    print("[PASS] Try49 prior smoke test completed successfully.")
