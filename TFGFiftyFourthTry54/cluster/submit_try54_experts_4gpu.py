...
def main() -> None:
    parser = argparse.ArgumentParser(description="Upload Try54 and submit the 6 topology experts as 4-GPU jobs.")
    ...
    try:
        ...
        if args.wipe_try54_outputs:
            remote_exec(
                ...
                f"rm -f {REMOTE_DIR}/logs_train_fiftyfourthtry54_* {REMOTE_DIR}/logs_cleanup_fiftyfourthtry54_*",
                check=False,
            )
