...
def train_one_epoch(
    ...
    *,
    ...
    denom = max(steps, 1)
    return running_g / denom, running_d / denom, running_no_data / denom


def main() -> None:
    parser = argparse.ArgumentParser(description="Train a Try 54 topology expert on top of the calibrated prior")
    ...
    try:
        for epoch in range(start_epoch, int(cfg["training"]["epochs"]) + 1):
            ...
            train_g_loss, train_d_loss, train_no_data_loss = train_one_epoch(
