...
- Base formula: `hybrid_two_ray_cost231_a2g_nlos`
- Regimes: `city_type x LoS/NLoS x antenna-height bin`
- Extra NLoS-aware pixel features:
  ...
  - normalized elevation angle `theta / 90`
  - `NLoS support x theta` interaction

The goal is to strengthen the prior specifically where `Try 42` still fails:

- `NLoS`
- lower antennas
- denser urban morphologies

## Validation RMSE

- `overall`: RMSE `23.5746 dB`, MAE `12.2583 dB`, count `485380287`
- `LoS`: RMSE `3.8138 dB`, MAE `3.0447 dB`, count `329805515`
- `NLoS`: RMSE `41.2686 dB`, MAE `31.7905 dB`, count `155574772`
