...
- Base formula: `a2g_paper_eq9_eq10_eq11`.
...
- `overall`: RMSE `23.6036 dB`, MAE `12.2776 dB`, count `485380287`
- `LoS`: RMSE `3.8143 dB`, MAE `3.0449 dB`, count `329805515`
- `NLoS`: RMSE `41.3202 dB`, MAE `31.8502 dB`, count `155574772`
