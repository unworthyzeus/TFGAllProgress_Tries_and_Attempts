...
- Base formula: `hybrid_shadowed_ripple_two_ray_vinogradov_nlos`.
...
- `overall`: RMSE `23.7511 dB`, MAE `12.0494 dB`, count `48861408`
- `LoS`: RMSE `3.3587 dB`, MAE `2.5405 dB`, count `33048375`
- `NLoS`: RMSE `41.4669 dB`, MAE `31.9225 dB`, count `15813033`
