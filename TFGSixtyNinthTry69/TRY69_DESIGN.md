...
reached 9.34 dB and never improved). The goal of Try 69 is twofold:
...
**Implementation in Try 69.** Added
...
**#1 Knife-edge diffraction prior — IMPLEMENTED in Try 69.**
...
**#2 PDE residual loss (PINN) — IMPLEMENTED in Try 69.**
...
**#3 Dual LoS/NLoS head — IMPLEMENTED in Try 69.**
...
**#4 Test-time adaptation (RadioPiT) — NOT implemented in Try 69.**
...
**#5 Diffusion refinement (RadioDiff-k²) — NOT implemented in Try 69.**
...
**#6 Foundation pre-training (FM-RME) — NOT implemented in Try 69.**
...
### Summary of what actually changed in Try 69

Implemented in Try 69: per-expert tight clamp, D4 TTA at final test,
...
A realistic Try 69 target is a validation RMSE of **7.5–8.5 dB** on the
...
### How Try 69 attacks NLoS specifically
...
are out of scope for Try 69 so the LR / regularisation / partition
