#!/usr/bin/env python3
"""SSH to the cluster and print disk usage for scratch / home / Try 66 tree.
...
USER = "gmoreno"
# Paths used by Try 66 jobs (see submit_try66_stage1_stage2_4gpu.py)
REMOTE_SCRATCH_USER = "/scratch/nas/3/gmoreno"
REMOTE_TFG_ROOT = f"{REMOTE_SCRATCH_USER}/TFGpractice"
REMOTE_TRY66 = f"{REMOTE_TFG_ROOT}/TFGSixtySixthTry66"
...
echo ""
echo "========== Largest items under Try 66 outputs (top 12) =========="
