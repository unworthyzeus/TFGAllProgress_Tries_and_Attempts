...
`Try 64` is the coarse-to-fine follow-up to `Try 63`.
...
- `scripts/generate_try64_configs.py`
- `scripts/plot_try64_metrics.py`
- `cluster/run_sixtyfourthtry64_4gpu.slurm`
- `cluster/submit_try64_stage1_stage2_4gpu.py`
