...
def main() -> None:
    parser = argparse.ArgumentParser(description="Predict with Try 45 PMNet-MoE prior+residual path-loss model")
    parser.add_argument("--config", type=str, default="experiments/fortyfifthtry45_pmnet_moe_enhanced_prior/fortyfifthtry45_pmnet_moe_enhanced_prior.yaml")
