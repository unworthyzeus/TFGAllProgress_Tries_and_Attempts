...
def _resolve_try58_topology_thresholds(data_cfg: Dict[str, Any]) -> Dict[str, float]:
...
def _infer_try58_topology_class(density: float, height: float, thresholds: Dict[str, float]) -> str:
...
def _compute_try58_topology_metadata(
    ...
    *,
    ...
    return {
        'topology_class': _infer_try58_topology_class(density, mean_height, thresholds),
    ...
    *,
    ...
    with h5py.File(hdf5_path, 'r') as handle:
        for city, sample in refs:
            ...
            meta = _compute_try58_topology_metadata(
                raw_topology,
                topology_thresholds,
...
def build_dataset_splits_from_config(cfg: Dict[str, Any]) -> Dict[str, Dataset]:
    ...
    if topology_class_filter:
        topology_thresholds = _resolve_try58_topology_thresholds(data_cfg)
