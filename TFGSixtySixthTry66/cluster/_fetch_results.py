...
USER = "gmoreno"
BASE = "/scratch/nas/3/gmoreno/TFGpractice/TFGSixtySixthTry66"
...
def main():
    ...
    print("=== OUT LOG ===")
    out = r(c, f"cat {BASE}/logs_train_try66_t66-open-sparse-lowrise_10027953.out 2>/dev/null")
    print(out[:4000])
    print()

    expert_dir = f"{BASE}/outputs/try66_expert_open_sparse_lowrise"
