...
def main() -> None:
    parser = argparse.ArgumentParser(description="Predict with Try 61 direct path-loss expert")
    parser.add_argument("--config", type=str, default="experiments/sixtyfirsttry61_partitioned_stage1/sixtyfirsttry61_expert_open_sparse_lowrise.yaml")
